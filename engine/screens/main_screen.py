...
from engine.gui.scatterplot import Graph_and_scatterplot
...
class Main_screen():
    def __init__(self, theme, window, manager):
        ...
        self.main_view.add_leaf(Graph_and_scatterplot("the scatterplot", pos_pct=(1., 1.), dim_pct=(1.,1.), parent=self.main_view, uid_generator=manager.uid_generator, color=self.color, manager=manager))
